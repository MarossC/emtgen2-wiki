...
const MapComponent2 = ({ nazev, imgSrc, metins, cotoje, pozadi, dostupneOd, pochazi, dropItems, activeIndex }) => {
        ...
        <Box className="obalovac">
          ...
          <Box className="hlavnicast">
            <Box className="detaily">
              ...
              <Box>
                <Typography className='nazev textos'>Pohází z</Typography>
                  {pochazi.map((bonus, index) => (
